...
(function() {
  if (window.__inklore404) return true;
  window.__inklore404 = true;
  var cfStrikes = 0;
  function check() {
    if (window.__inkloreNavDone) return;
...
(function() {
  if (window.__inkloreAuto) return true;
  window.__inkloreAuto = true;
...
(function() {
  if (window.__inkloreChapNav) return true;
  if (!/\/title\/[a-f0-9-]+/i.test(window.location.pathname)) return true;
  window.__inkloreChapNav = true;
...
(function() {
  if (window.__inkloreChapClick) return true;
  window.__inkloreChapClick = true;
