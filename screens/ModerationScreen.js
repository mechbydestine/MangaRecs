...
const styles = StyleSheet.create({
  ...
  toggleText: { color: '#7858FF', fontSize: 12, fontWeight: '600' },
  ...
  resolveBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#7858FF', borderRadius: 10, paddingVertical: 9, alignSelf: 'flex-start', paddingHorizontal: 14 },
