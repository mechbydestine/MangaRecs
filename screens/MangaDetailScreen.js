...
const styles = StyleSheet.create({
  ...
  formatPill: { backgroundColor: 'rgba(120, 88, 255,0.16)', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 4 },
  formatPillText: { color: '#7858FF', fontSize: 10.5, fontWeight: '800', letterSpacing: 0.5 },
  ...
  readBtn: {
    ...
    backgroundColor: '#7858FF', borderRadius: 14, height: 52,
    shadowColor: '#7858FF', shadowOpacity: 0.6, shadowRadius: 14, shadowOffset: { width: 0, height: 4 },
    elevation: 10,
  },
  ...
  showMore: { color: '#7858FF', fontSize: 13, fontWeight: '600', marginTop: 8 },
