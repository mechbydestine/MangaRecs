...
function Screen6({ username, onChange }) {
  return (
    <View style={styles.screenPad}>
      ...
      <Text style={styles.highlightText}>Choose a username for your Inklore profile.</Text>
...
export default function OnboardingScreen({ onComplete }) {
  ...
  async function finishOnboarding() {
    ...
    try {
      ...
      await AsyncStorage.setItem('@inklore_genre_prefs', JSON.stringify(initialWeights));
