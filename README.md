...
**[Download the APK](https://github.com/mechbydestine/MangaRecs/releases/download/v1.2.0-preview/MangaRecs.apk)** — hosted directly on this repo's [Releases](https://github.com/mechbydestine/MangaRecs/releases) page, no Expo account or login needed. Install the `.apk` directly on your phone or tablet (you'll need to allow installs from unknown sources the first time).
