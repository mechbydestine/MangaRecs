...
(function () {
  ...
  var T = {
    en: {
      ...
      'trending.seeAll': 'See more trending',
      'growing.seeAll': 'See more climbing titles',
      ...
      'ch3.desc': "250 badges worth chasing. Climb Bronze to Mythic and keep a streak alive. It's also the groundwork for the community modes we're building next, starting with server-wide events.",
    ...
    ja: {
      ...
      'trending.seeAll': 'トレンドをもっと見る',
      'growing.seeAll': '急上昇の作品をもっと見る',
      'ch1.eyebrow': '第1章',
      'ch1.title': '集める',
      ...
      'ch3.desc': '色が変わるだけのトロフィーではなく、本気で狙える250個のバッジ。ブロンズからミシックまで駆け上がり、連続記録を守りましょう。今後追加するコミュニティモードの土台でもあり、個人の記録だけでなくサーバー全体のイベントを見据えています。',
    ...
    ko: {
      ...
      'trending.seeAll': '인기 작품 더 보기',
      'growing.seeAll': '떠오르는 작품 더 보기',
      'ch1.eyebrow': '1장',
      'ch1.title': '모으기',
      ...
      'ch3.desc': '색만 바뀌는 트로피 하나가 아니라, 정말로 노려볼 만한 250개의 배지. 브론즈에서 미식까지 올라가고, 연속 기록을 지켜보세요. 다음에 만들 커뮤니티 모드의 토대이기도 해서, 개인 기록을 넘어 서버 전체 이벤트까지 이어집니다.',
    ...
    zh: {
      ...
      'trending.title': '当下热门',
      'trending.seeAll': '查看更多热门作品',
      'growing.seeAll': '查看更多上升作品',
      'ch1.eyebrow': '第一章',
      'ch1.title': '收藏',
      ...
      'ch3.desc': '250 枚值得认真追的徽章，而不是一个只会变色的奖杯。从青铜爬到神话，守住连续记录。它也是我们接下来要做的社群玩法的地基：想象全服活动，而不只是一个人的连续天数。',
    ...
    es: {
      ...
      'trending.seeAll': 'Ver más tendencias',
      'growing.seeAll': 'Ver más títulos en ascenso',
      ...
      'ch3.desc': '250 insignias que de verdad merece la pena perseguir, no un trofeo que solo cambia de color. Sube de Bronce a Mítico y mantén viva tu racha. También es la base de los modos comunitarios que vienen después: piensa en eventos para todo el servidor, no solo en un contador personal.',
    ...
    fr: {
      ...
      'trending.seeAll': 'Voir plus de tendances',
      'growing.seeAll': 'Voir plus de titres qui montent',
      ...
      'ch3.desc': "250 badges à courir après pour de vrai, pas un trophée unique qui change juste de couleur. Grimpez de Bronze à Mythique et gardez une série de jours en vie. C'est aussi la base des modes communautaires qui arrivent : imaginez des événements à l'échelle du serveur, pas un simple compteur personnel.",
