...
(function () {
  ...
  var T = {
    en: {
      ...
      'ch5.title': 'Read',
      'ch2.desc': 'See what your friends are actually reading right now, not just what they finished months ago. Send them the chapter that wrecked you, or "Rec" them a whole series straight into their library. Threads are spoiler-tagged by chapter, so someone three behind can still scroll through without getting burned.',
      'ch2.li1': "Rec a title straight to a friend's library — not just a link, an actual save",
      'ch2.li2': 'Live reading activity, not a stale "last seen" timestamp',
      'ch2.li3': 'Spoiler-tagged discussion threads, per chapter, per series',
      'ch3.desc': "250 badges to actually chase, not one trophy icon that just changes color. Climb Bronze to Mythic, keep a streak alive, and unlock relics — original weapon art we drew ourselves, not stock icon-pack junk. It's also the foundation for the community modes we're building next: think server-wide events, not just a personal streak counter.",
      'ch3.li1': 'Bronze → Silver → Gold → Mythic, a real ladder, not a progress bar',
      'ch3.li2': 'Streaks and a live leaderboard against your friends',
      'ch3.li3': "The Relic Vault: hand-drawn rewards, nothing you've seen in a hundred other apps",
      'ch4.desc': "Once your library's got a shape, the feed uses it. Swipe right to save, left to skip — it keeps adjusting instead of asking you to fill out a genre survey once and forget it. Tap a mood chip and it reshuffles on the spot.",
      'ch4.li1': 'Like, comment, and share straight from the card — no tab-switching',
      'ch4.li2': 'A taste radar that keeps adjusting, not a genre filter you set once and forget',
      'ch5.desc': "However you found it — your library, a friend's Rec, or the feed — read it right in the app. Scroll it like a webtoon or flip it like paged manga, your call per series. Ambient sound, a screen dimmer, and auto-scroll for the chapters you're reading at 1am and don't want to keep tapping.",
      'ch5.li1': "Works as a clean, ad-blocked reader on other sites too — not just the ones we've built native support for",
      ...
      'updates.d1': 'Manga, manhwa, manhua, webcomics and novels — browsable right now, <em>no account needed</em>.',
